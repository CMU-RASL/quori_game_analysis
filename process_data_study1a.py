...
database_filenames = ['data/study1a_1.db', 'data/study1a_2.db']
approved_ids_filenames = ['data/study1a_1_prolific_approval.txt', 'data/study1a_2_prolific_approval.txt']
...
def compile_data(tabs):
    ...
    for user_id in tabs['user']['id'].tolist():
        ...
        if username == 'dawna.masi@gmail.com':
            username = '60fda870afb7194befe97ef5'

        if username == 'Givenchilwane':
            username = '60fab30422ea64af04188cac'

        if username == '221B97D0':
            username = '5f2d2a4830c9b103b1f24c1d'

        if username == 'sawberryshortcake@gmail.com':
            username = '60fde94c5d46b11e99a2445a'

        if username == 'Britiki':
            username = '60fd7d24d0019dbf9173f694'

        if username == 'Laeeqa Doutie':
            username = '60fd364b6df9086ada3e79de'

        if username == 'samkariolich':
            username = '60fd25bcb6e6c7bf1743d597'

        if username == 'corinne.ba@web.de':
            username = '61072601b172bb0c9d2a0f99'
        
        if username == 'gebashesane@gmail.com ':
            username = '611cddf978c77d9dc40faa4c'
        
        if username == 'JOHN.MATOS17@GMAIL.COM':
            username = '6126671f7dfcda926b3a95bc'
        
        if username == '61241d6101ba6a2037903133@email.prolific.co':
            username = '61241d6101ba6a2037903133'
        
        if username == 'cdavidgow@gmail.com':
            username = '6121e3174b21b16b1a96030d'
        
        if username == 'Liu67y67y@outlook.com':
            username = '612010d9e304c4120ea33fa2'
        
        if username == 'nenarhsamkerh@gmail.com':
            username = '6116f805aa7ba31a8bb51f1b'
...
if __name__ == '__main__':
    ...
    filehandler = open('data/study1a_data.pkl',"wb")
    pkl.dump(data,filehandler)
    filehandler.close()
    print(data.shape)
    print(tabs['condition'])