...
if __name__ == '__main__':
    ...
    for split in range(5):
        ...
        for num_parameter_ind, num_hidden_units in enumerate(num_hidden_units_arr):
            ...
            print('Split {}/5 - Parameter {}'.format(split+1, num_parameter_ind+1))
    ...
    plot_acc(num_hidden_units_arr, all_train_res, 'Train Data - Number of Hidden Units - ' + model_type)
    plot_acc(num_hidden_units_arr, all_test_res, 'Test Data - Number of Hidden Units - ' + model_type)
    plt.show()
