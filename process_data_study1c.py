...
database_filenames = ['data/study1c.db']
approved_ids_filenames = ['data/study1c_prolific_approval.txt']
easy_answers = [1, 0, 0, 1, 1, 0, 1, 1]
difficult_answers = [0, 1, 0, 0, 0, 1, 0, 0]
plt.rcParams.update({'font.size': 16})
CONDITIONS = [(('EASY', 'MATCHING'), ('DIFFICULT', 'MATCHING')), (('EASY', 'NONMATCHING'), ('DIFFICULT', 'NONMATCHING')), (('DIFFICULT', 'MATCHING'), ('EASY', 'MATCHING')), (('DIFFICULT', 'NONMATCHING'), ('EASY', 'NONMATCHING')), 
(('EASY', 'NONMATCHING'), ('DIFFICULT', 'MATCHING')), (('EASY', 'MATCHING'), ('DIFFICULT', 'NONMATCHING')), (('DIFFICULT', 'NONMATCHING'), ('EASY', 'MATCHING')), (('DIFFICULT', 'MATCHING'), ('EASY', 'NONMATCHING')),
]
